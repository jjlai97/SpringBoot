...
public class AppUserService implements UserDetailsService {
    ...
    public String signUpUser(AppUser appUser) {
        ...
        if (!userExists) {
            ...
            boolean isUserConfirmed = appUserRepository
                    .findByEmail(appUser.getEmail()).get().isEnabled();
            if (!isUserConfirmed) {
                Long id = appUserRepository.findByEmail(appUser.getEmail()).get().getId();
                ConfirmationToken token = confirmationTokenService.findByAppUserId(id).get();
